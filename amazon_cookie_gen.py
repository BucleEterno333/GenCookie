...
# Orden de países para Hero SMS (barato a caro, según tu preferencia 'MA' da sms no disponible, KG no tiene numeros disponibles)
...
async def create_amazon_account(country_code, add_address_flag=True, max_retries=None, max_internal_retries=10, service_preference=None):
    ...
    for global_attempt in range(1, retries + 1):
        ...
        try:
            ...
            # ----- PASO 4: OBTENER NÚMERO (SOLO UNA VEZ POR INTENTO GLOBAL) -----
            try:
